"""
core/urls.py
All API routes — mounted under /api/v1/ in the project urls.py
"""
...
from core.views import (
    ...
    FlashDealListView, ReviewCreateView, BrandListView,
    # Delivery
    CountyListView, TownDetailView, StationListView, HomeDeliveryDetailView,
    # Orders
    OrderListCreateView, OrderDetailView, CancelOrderView, CouponValidateView,
    # Payments
...
urlpatterns = [
    ...
    # ── Products ──────────────────────────────────────────────────────────────
    # flash-deals must come before <slug:slug> to avoid slug collision
